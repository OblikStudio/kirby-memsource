...
},{"./components/Crumbs.vue":35,"./components/Export.vue":36,"./components/Login.vue":38,"./components/Project.vue":39,"./components/Projects.vue":40,"vue":32,"vue-hot-reload-api":1,"vueify/lib/insert-css":2}],35:[function(require,module,exports){
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"ms-export"},[_c('div',{staticClass:"stats"},_vm._l((_vm.stats),function(stat){return _c('div',{key:stat.title,staticClass:"stat"},[_c('span',[_vm._v(_vm._s(stat.title))]),_vm._v(" "),_c('hr'),_vm._v(" "),_c('span',[_vm._v(_vm._s(stat.value.toLocaleString()))])])})),_vm._v(" "),_c('form',{on:{"submit":_vm.submit}},[_c('label',{staticClass:"label",attrs:{"for":"ms-export-options"}},[_vm._v("Create job for:")]),_vm._v(" "),_c('div',{staticClass:"field-content"},[_c('div',{staticClass:"input input-with-selectbox",class:{
                'input-is-focused': _vm.isFocused
            }},[_c('div',{staticClass:"selectbox-wrapper"},[_c('select',{directives:[{name:"model",rawName:"v-model",value:(_vm.exportLanguages),expression:"exportLanguages"}],staticClass:"selectbox",attrs:{"id":"ms-export-options"},on:{"focus":function($event){_vm.isFocused = true},"blur":function($event){_vm.isFocused = false},"change":function($event){var $$selectedVal = Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return val}); _vm.exportLanguages=$event.target.multiple ? $$selectedVal : $$selectedVal[0]}}},_vm._l((_vm.exportOptions),function(option){return _c('option',{key:option.value,domProps:{"value":option.value}},[_vm._v("\n                            "+_vm._s(option.text)+"\n                        ")])}))])]),_vm._v(" "),_vm._m(0)]),_vm._v(" "),_c('button',{staticClass:"btn btn-rounded btn-action"},[_vm._v("Upload")])])])}
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('dir',{staticClass:"ms-projects"},[(_vm.$store.state.memsource.projects.length)?_c('div',{staticClass:"dashboard-box"},[_c('ul',{staticClass:"dashboard-items"},_vm._l((_vm.$store.state.memsource.projects),function(project){return _c('li',{staticClass:"dashboard-item project"},[_c('button',{on:{"click":function($event){_vm.$emit('selectProject', project)}}},[_c('span',{staticClass:"dashboard-item-icon dashboard-item-icon-with-border",attrs:{"title":"Source language"}},[_c('span',{staticClass:"lang-container"},[_c('span',{class:{
                            ...
                            }},[_vm._v("\n                                "+_vm._s(project.sourceLang)+"\n                            ")])])]),_vm._v(" "),_c('p',{staticClass:"dashboard-item-text"},[_c('span',[_vm._v(_vm._s(project.name))]),_vm._v(" "),_c('span',{staticClass:"targets",attrs:{"title":"Target languages"}},_vm._l((project.targetLangs),function(lang){return _c('span',{class:{
                                lang: true,
